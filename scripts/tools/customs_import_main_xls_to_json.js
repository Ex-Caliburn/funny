...
/**
 * 将海关总署「进口主要商品量值表」.xls 转为结构化 JSON
 *
 * 用法：
 *   node scripts/tools/customs_import_main_xls_to_json.js
 *   node scripts/tools/customs_import_main_xls_to_json.js /path/to/dir_or_file.xls
 *   node scripts/tools/customs_import_main_xls_to_json.js /path/to/dir_or_file.xls /path/to/out.json
 */
...
const DEFAULT_INPUT_DIR = path.join(__dirname, '../../stock/customs_import_main')
const DEFAULT_OUTPUT = path.join(DEFAULT_INPUT_DIR, 'customs_import_main_rmb.json')
const FILE_PATTERN = /进口主要商品量值表/
