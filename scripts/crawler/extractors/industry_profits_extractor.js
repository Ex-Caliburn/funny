const IndustrialValueAddedExtractor = require('./industrial_value_added_extractor');
const path = require('path');

/**
 * 分行业工业企业利润数据提取器
 * 继承自工业增加值数据提取器，只是保存到不同的目录
 */
class IndustryProfitsExtractor extends IndustrialValueAddedExtractor {
